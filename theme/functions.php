...
/**
 * [DAZ] Custom Post Types
 */

function cptui_register_my_cpts_bookmarks() {
	...
	$labels = [
		"name" => __( "Bookmarks", "cyanotype" ),
		"singular_name" => __( "Bookmark", "cyanotype" ),
	];

	$args = [
		"label" => __( "Bookmarks", "cyanotype" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		...
		"map_meta_cap" => true,
		"hierarchical" => false,
		"rewrite" => [ "slug" => "bookmarks", "with_front" => true ],
		"query_var" => true,
...
add_action( 'init', 'cptui_register_my_cpts_bookmarks' );


function cptui_register_my_cpts_definition() {
	...
	$labels = [
		"name" => __( "Definitions", "cyanotype" ),
		"singular_name" => __( "Definition", "cyanotype" ),
	];

	$args = [
		"label" => __( "Definitions", "cyanotype" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		"publicly_queryable" => true,
		...
		"map_meta_cap" => true,
		"hierarchical" => false,
		"rewrite" => [ "slug" => "definitions", "with_front" => true ],
		"query_var" => true,
...
add_action( 'init', 'cptui_register_my_cpts_definition' );
